...
import com.gipl.swayam.databinding.LayoutNotificationListBinding;
...
import com.gipl.swayam.ui.notification.adapter.NotificationListAdapter;
        ...
        adapter.setListener(notification -> {
            ...
            if (AppUtility.LINK_TYPE.IMAGE.equalsIgnoreCase(notification.getLinkType())) {
                ...
                if (notification.getLink().isEmpty()) {
                    DialogUtility.showSnackbar(getViewDataBinding().getRoot(), getString(R.string.msg_pdf_link_empty));
                    return;
                }
